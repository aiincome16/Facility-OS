...
function renderRoute(route, state) {
    ...
    switch (route) {
        ...
        case "/objects":
            ...
            return renderObjectsPage(state);

        case "/object-detail":

            return renderObjectDetailPage(state);
...
export function renderApp({
    ...
    const objectGuideButtons =
        appElement.querySelectorAll(
            '[data-action="open-object-guide"]'
        );

    objectGuideButtons.forEach(
        (button) => {
            ...
            button.addEventListener(
                ...
                () => {
                    ...
                    window.alert(
                        "Die Objektanleitung wird als nächstes als eigene Seite aufgebaut."
                    );
                }
            );
        }
    ...
    const keybookButtons =
        appElement.querySelectorAll(
            '[data-action="open-keybook"]'
        );

    keybookButtons.forEach(
        (button) => {
            ...
            button.addEventListener(
                ...
                () => {
                    ...
                    window.alert(
                        "Das Schlüsselbuch wird als nächstes als eigene Seite aufgebaut."
                    );
                }
            );
        }
